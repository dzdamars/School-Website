	...
	<div id="panel-misc-portlet-r1" class="panel panel-default">
			...
			<div class="panel-body">				
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<?php echo form_open_multipart('admin/insert/berita', 'id="form_berita"') ?>
						<div class="row">
						...
						<div class="row">
							...
							<div class="col-md-5 col-md-5">
								...
								<select  name="cat" class="form-control select2">
									...
									<option value="<?=$c->category_id?>" <?php echo ($c->category_id == set_value('cat') ? 'selected="selected"' : '') ?>><?=$c->category_name?></option>
									<?php } ?>
								</select>
							</div>
						</div>
